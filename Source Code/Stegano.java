...
class Yframe extends JFrame implements ActionListener
{
	...
	setIconImage(new ImageIcon("images/cdpack.gif").getImage()); 
    //Menubar
	    mb = new JMenuBar();
	    setJMenuBar(mb);
	    file = new JMenu("File");
	    file.add(fopen=new JMenu("Open..."));
	    fopen.add(f1=new JMenuItem("Cover Image",new ImageIcon("images/open2.gif"))); f1.setMnemonic(KeyEvent.VK_O);          		f1.addActionListener(this);
	        f1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_O, ActionEvent.CTRL_MASK));    
	        fopen.add(f2=new JMenuItem("Text",new ImageIcon("images/txticon3.gif")));   f2.setMnemonic(KeyEvent.VK_T);  	f2.addActionListener(this); 
        fopen.add(f7=new JMenuItem("Image",new ImageIcon("images/video.gif")));  f7.setMnemonic(KeyEvent.VK_I);  	f7.addActionListener(this); 
        file.add(f8=new JMenuItem("Close",new ImageIcon("images/stop.gif")));   f8.setMnemonic(KeyEvent.VK_C);  	f8.addActionListener(this); 
	file.addSeparator(); 
        file.add(f3=new JMenuItem("Save",new ImageIcon("images/save.gif")));     f3.setMnemonic(KeyEvent.VK_S); 	f3.addActionListener(this);
	f3.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S, ActionEvent.CTRL_MASK));
	file.add(f4=new JMenuItem("Save As...",new 	ImageIcon("images/saveas.gif")));f4.setMnemonic(KeyEvent.VK_A);f4.addActionListener(this);
        file.addSeparator();
        file.add(f6=new JMenuItem("Exit",new ImageIcon("images/close.gif")));     f6.setMnemonic(KeyEvent.VK_X); 	f6.addActionListener(this);
        file.setMnemonic(KeyEvent.VK_F);
        mb.add(file);
	edit = new JMenu("Edit");
	edit.setMnemonic(KeyEvent.VK_E);
/*	edit.add(e6=new JMenuItem("Undo",new ImageIcon("images/undo.gif")));   
	e6.setMnemonic(KeyEvent.VK_U);  e6.addActionListener(this);
	e6.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Z, ActionEvent.CTRL_MASK));    
        edit.add(e7=new JMenuItem("Redo",new ImageIcon("images/redo.gif")));  
	e7.setMnemonic(KeyEvent.VK_R);  e7.addActionListener(this);
	e7.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Y, ActionEvent.CTRL_MASK));       
	edit.addSeparator();
*/	
	edit.add(e1=new JMenuItem("Cut",new ImageIcon("images/cut.gif")));   e1.setMnemonic(KeyEvent.VK_T);  	e1.addActionListener(this);
	e1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_X, ActionEvent.CTRL_MASK));    
        edit.add(e2=new JMenuItem("Copy",new ImageIcon("images/copy.gif")));  e2.setMnemonic(KeyEvent.VK_C);  	e2.addActionListener(this); 
	e2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_C, ActionEvent.CTRL_MASK));       
	edit.add(e3=new JMenuItem("Paste",new ImageIcon("images/paste.gif"))); e3.setMnemonic(KeyEvent.VK_P);  	e3.addActionListener(this);
	e3.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_V, ActionEvent.CTRL_MASK));
	edit.addSeparator();
	edit.add(e4=new JMenuItem("Delete",new ImageIcon("images/close.gif")));e4.setMnemonic(KeyEvent.VK_L);  	e4.addActionListener(this);
        e4.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_DELETE,0));
        edit.add(e5=new JMenuItem("Select All",new ImageIcon("images/txticon1.gif")));e5.setMnemonic(KeyEvent.VK_A);  	e5.addActionListener(this);
        e5.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_A,ActionEvent.CTRL_MASK));
	mb.add(edit);
	tools = new JMenu("Tools");
	tools.add(t1=new JMenuItem("Make Stegano Image",new ImageIcon("images/wheel.gif")));t1.setMnemonic(KeyEvent.VK_M); 	t1.addActionListener(this);
	t1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_M,ActionEvent.CTRL_MASK));
	tools.add(t2=new JMenuItem("Read Stegano Data",new ImageIcon("images/wheel.gif")));t2.setMnemonic(KeyEvent.VK_R); 	t2.addActionListener(this);
	t2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_R,ActionEvent.CTRL_MASK));
	tools.addSeparator();
	tools.add(t3=new JMenuItem("Properties",new ImageIcon("images/display.gif")));t3.setMnemonic(KeyEvent.VK_P); 	t3.addActionListener(this);
	...
	help.add(h1=new JMenuItem("Steganography Help",new 	ImageIcon("images/help.gif")));h1.setMnemonic(KeyEvent.VK_S);h1.addActionListener(this);
	help.add(h2=new JMenuItem("About...",new 	ImageIcon("images/information.gif")));h2.setMnemonic(KeyEvent.VK_A);h2.addActionListener(this);
	mb.add(help);
     	f2.setEnabled(false);
	f3.setEnabled(false);
	f4.setEnabled(false);
...
public void actionPerformed(ActionEvent e)
  {
   ...
   if(s.equals("Cover Image")||s.equals("Image"))
	...
	//filefilter.accept(new File(dn),fn); 
	//fd1.setFilenameFilter(filefilter);
        fd1.setDirectory(dn); 	
	fd1.show();
	//fd1.fileFilter(new ImageFilter());
        //fd1.setFileView(new ImageFileView());
         //fd1.setAccessory(new ImagePreview(fd1));
	    dn=fd1.getDirectory();
		         fn=fd1.getFile();
         ...
         if(s.equals("Text") && t.getSelectedIndex()==0)
        {
		 ...
		 fd1=new FileDialog(this,"open",FileDialog.LOAD);
                //fd1.setChoosableFileFilter(new TextFilter());
                //fd1.setFileView(new ImageFileView());
	 ...
	 JOptionPane.showMessageDialog(new Yframe(),"   Steganography 1.0",
                                    "About Steganography...",
...
final Window w;
 ...
 //w.setOpaque(false);
 //final JDialog d=new JDialog(yf);
